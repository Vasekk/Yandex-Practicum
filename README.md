...
|14| Базовый SQL | Срезы, группировка, сортировка, подзапросы, оконные функции, PySpark  | [SQL запросы](https://github.com/Vasekk/Yandex-Practicum/tree/main/14_SQL) | SQL запросы | Срезы, группировка, сортировка, подзапросы |
