...
|6| Введение в машинное обучение |Модели классификации и регресии, качество моделей| [Классификации для выбора мобильного тарифа ](https://github.com/Vasekk/Yandex-Practicum/tree/main/6_Сlassification_for_mobile_tariff_recommendation) | модель классификации по использованию услуг для рекомендации тарифа пользователей архивных тарифов | `pandas` `sklearn` `Классификация`|
